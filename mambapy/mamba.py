...
class MambaBlock(nn.Module):
    ...
    def __init__(self, config: MambaConfig, use_bimamba=True, use_shift=False):             #add:not use shift
        super().__init__()
    ...
    def forward(self, x):
        ...
        return output     #torch.Size([13, 900, 256])
